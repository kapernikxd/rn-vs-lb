// components/Chat/ChatItem.stories.tsx
...
export const PersonOnline: Story = {
  args: {
    variant: 'person',
...
export const PersonOffline: Story = {
  args: {
    variant: 'person',
...
export const GroupWithSender: Story = {
  args: {
    variant: 'group',
...
export const LongMessageTruncation: Story = {
  args: {
    variant: 'group',
